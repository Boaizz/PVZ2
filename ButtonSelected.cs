...
namespace CustomProgram
{
    public class ButtonSelected : Button //this button is used for selecting the card
    {
        ...
        { 
            SplashKit.SpriteAddLayer(this.Sprite, new Bitmap("selected Button 1", "buttonB2.png"), "On Hover");
            SplashKit.SpriteAddLayer(this.Sprite, new Bitmap("selected Button 2", "buttonB3.png"), "On Click");
        }
