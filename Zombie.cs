...
namespace CustomProgram
{
    public abstract class Zombie : GameObject
    {
        ...
        public void ChangeSpeed()
        {
            ...
            else if (_slowingTime > 0) SplashKit.SpriteSetDx(this.Sprite, -0.2f); //change speed when icepea hit
            else if (_stunningTime > 0) SplashKit.SpriteSetDx(this.Sprite, 0); //change speed when lightningpea hit
            else SplashKit.SpriteSetDx(this.Sprite, -0.5f); //normal speed
        }
